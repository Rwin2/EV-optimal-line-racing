...
\textbf{Metrics.} We will evaluate each approach on lap time $T_{\text{lap}}$, energy consumed $\Delta SOC$, ride smoothness $\int \|\dot{\mathbf{u}}\|^2 dt$, and solver runtime. We will also construct Pareto fronts between lap time and energy use to characterize the tradeoff.
