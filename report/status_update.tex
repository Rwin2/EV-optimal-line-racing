...
\vspace{-0.05in}
\paragraph{Remaining Work.} Incorporate battery energy consumption into the objective to formulate a multiobjective optimization problem and trace the Pareto front between lap time and energy usage; study optimization under uncertainty by adding stochastic perturbations to tire grip; benchmark across multiple track geometries.
